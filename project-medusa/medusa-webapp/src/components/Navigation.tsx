...
export default function Navigation() {
  ...
  return (
    <nav className="w-64 bg-slate-800 border-r border-slate-700 h-full overflow-y-auto">
      <div className="p-4">
        {/* Logo */}
        <div className="flex items-center mb-8">
          ...
          <div>
            <h1 className="text-lg font-bold text-white">MedCare EHR</h1>
        ...
        <div className="mt-8 pt-4 border-t border-slate-700">
          <div className="flex items-center px-3 py-2">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-white">Dr. Admin User</p>
              <p className="text-xs text-slate-400">Physician</p>
            </div>
          </div>
          <Link 
            href="/"
            className="flex items-center w-full px-3 py-2 text-sm text-slate-400 hover:text-white hover:bg-slate-700 rounded-lg transition-colors mt-2"
          >
